...
#click save button
    ...
    def test_check_roles_1(self):
        ...
        parent_role = function.driver.find_element(By.ID, "1-switch-group-Role").is_selected()
        create_role = function.driver.find_element(By.ID , "1-switch-item-can_create").is_selected()
        read_role = function.driver.find_element(By.ID, "1-switch-item-can_read").is_selected()
        update_role = function.driver.find_element(By.ID, "1-switch-item-can_update").is_selected()
        delete_role = function.driver.find_element(By.ID, "1-switch-item-can_delete").is_selected()
        print(parent_role)
        print(create_role)
        print(read_role)
        print(update_role)
    ...
    def test_check_roles_2(self):
            ...
            function.driver.find_element(By.ID, "1-switch-item-can_read").click()
            time.sleep(2)
    ...
    def test_check_roles_3(self):
        ...
        function.driver.find_element(By.ID, "1-switch-item-can_read").click()
        time.sleep(3)
        roles2=function.driver.find_element(By.ID, "1-switch-group-Role").is_selected()
        assert roles2 == True
